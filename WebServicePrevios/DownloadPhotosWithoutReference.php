...
class DownloadPhotosWithoutReference
{
     ...
     */
    public function __construct($idclient, $idprevious)
    {
     ...
     * @return string
     */
    public function downloadPhotosWithotReference()
    {
        // validamos Cliente
        if ($this->getIdclient() == ''  || $this->getIdprevious() == '') {
            ...
            try {
                ...
                if ($id_cliente > 0) {
                    ...
                    $db->setParameters("CR.id_prev = '" . $this->getIdprevious() . "' AND L.id_cliente =  " . $this->getIdclient() . "");
                    ...
                    if ($idprev > 0) {
                        ...
                        $numRefe = $detailReference[0]["num_refe"];
                        ...
                        $db->setParameters("F.id_prev = " . $this->getIdprevious() . "");
                        $db->setReturnType(PgsqlQueries::TYPE_ARRAY_ALL);
                        ...
                        foreach ($generalFiles as $generalFile) {
                            ...
                            $previoFile->setNum_refe($numRefe);
                        ...
                        foreach ($invoices as $invoice) {
                            ...
                            foreach ($products as $product) {
                                ...
                                foreach ($files as $file) {
                                    $File = new File($this->getIdclient(), $numRefe, $file["cons_foto"], $file["nom_foto"], null, $keyCustome);
