...
class Products
{
 ...
 /**
    ...
    /**
     * @return the $part_extra
     */
    public function getPart_extra()
    {
        return $this->part_extra;
    }

    /**
     * @param number $part_extra
     */
    public function setPart_extra($part_extra)
    {
        $this->part_extra = $part_extra;
    }
