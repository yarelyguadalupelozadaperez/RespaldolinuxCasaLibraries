...
class PdfDespachador extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Image($this->background, 0, 0, 250, 284, '', '', '', false, 300, '', false, false, 0);
    ...
    public function Footer() {
        ...
        $this->SetY(-17);
        $this->SetX(-20);
        $this->Cell(0, 10, 'Pagina '.$this->getAliasNumPage().'/'.$this->getAliasNbPages(), 0, false, 'R', 0, '', 0, false, 'T', 'B');        
        $this->SetFont('helvetica', 'B', 7);
        $this->SetY(-17);
        $this->SetX(20);
